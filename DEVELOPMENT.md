...
```bash
git remote add encore encore://atexya-cash-app-i2hi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/atexya-cash-app-i2hi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/atexya-cash-app-i2hi/settings/integrations/github)
